...
Description:  This plugin enables you to set conditional menus per posts, pages, categories, archive pages, and more.
...
class Themify_Conditional_Menus {
	...
	public function get_visibility_options( $selected = array() ) {
		...
		$output .= '<input type="hidden" id="themify-cm-original-conditions" value="'.esc_attr( $values ).'"/>';
		return $output;
	}
